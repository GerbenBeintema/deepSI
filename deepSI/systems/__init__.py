...
from deepSI.systems.book_based_systems import nonlin_Ibased_normals_system,\
                Hammerstein_sys_ID_book, Wiener_sys_ID_book, WienerV2_sys_ID_book,\
                 NDE_squared_sys_ID_book, dynamic_nonlin_sys_ID_book
from deepSI.systems.example_2_non_lin import example_2_non_lin
from deepSI.systems.nonlinear_RLC import nonlinear_RLC
all_systems = [Test_ss_linear1, Double_bath, Cheby1, Butter, Pendulum,nonlin_Ibased_normals_system,example_2_non_lin,Hammerstein_sys_ID_book,Wiener_sys_ID_book,
...
from deepSI.systems.boucwen import BoucWen